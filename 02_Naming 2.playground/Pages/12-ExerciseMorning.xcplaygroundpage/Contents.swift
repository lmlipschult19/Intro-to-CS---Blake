...
let takeMedicine = 1
let getDressed = 4
let micellaneousActivities = 7
let breakfast = 10
let packBackpack = 1
let totalTime = brushTeeth + shower + chooseClothes + takeMedicine + getDressed + micellaneousActivities + breakfast + packBackpack
...
*/
// already treid to use accurate amounts for time, so no need to change stuff
